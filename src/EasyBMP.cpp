...
{ 
 ...
 // ---------------------------------------------------------------------------
 // ---------------------------------------------------------------------------
 // Bug fix(crutch) by Sheprut Ilya at 3.05.2017
 // For GrapiWinAPI library
 if (bmih.biHeight >> 31 == 1)	bmih.biHeight = 0xFFFFFFFF - bmih.biHeight;
 if (bmih.biWidth >> 31 == 1)	bmih.biWidth = 0xFFFFFFFF - bmih.biWidth;
 // ---------------------------------------------------------------------------
 // ---------------------------------------------------------------------------
 // ---------------------------------------------------------------------------
